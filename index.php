    ...
    <section id="faq" class="faq">
      <div class="container">
        ...
        <ul class="faq-list">
          ...
          <li>
            <div data-bs-toggle="collapse" href="#faq2" class="collapsed question">How I can know when the vaccination schedule will start? <i class="bi bi-chevron-down icon-show"></i><i class="bi bi-chevron-up icon-close"></i></div>
